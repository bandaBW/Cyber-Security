...
# ALL-YOU-NEED-TO-HACK-EFFECTIVELY!
...
8. 	nmap -p 445 --script smb-enum-users <target> — enumerate users via nmap

9. Brute Force Windows Server SMB Credentials with Metasploit - use auxiliary/scanner/smb/smb_login
